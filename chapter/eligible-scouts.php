<?php
$title = "Edit Eligible Scouts | Chapter Election Portal | Shenandoah Lodge - Order of the Arrow, BSA";
...
<head>
    ...
    <title>Eligible Scouts | Unit Elections Administration | Shenandoah Lodge - Order of the Arrow, BSA</title>
