<?php
$title = "Edit Unit Election | Unit Leader Election Portal | Shenandoah Lodge - Order of the Arrow, BSA";
...
<head>
    ...
    <title>Edit Unit Election | Shenandoah Lodge - Order of the Arrow, BSA</title>
