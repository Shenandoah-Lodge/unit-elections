<?php
$title = "New Adult Nomination | Unit Leader Election Portal | Shenandoah Lodge - Order of the Arrow, BSA";
...
<head>
    ...
    <title>New Adult Nomination | Unit Leader Election Portal | Shenandoah Lodge - Order of the Arrow, BSA</title>
