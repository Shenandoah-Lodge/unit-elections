<?php
$title = "Election Results | Unit Leader Election Portal | Shenandoah Lodge - Order of the Arrow, BSA";
...
<head>
    ...
    <title>Results | Unit Elections Administration | Shenandoah Lodge - Order of the Arrow, BSA</title>
